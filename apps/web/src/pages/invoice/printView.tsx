...
interface PrintViewProps {
    ...
    printInvoice: any;
    /** Map of applied tax rows keyed by `${TaxId}_${rate}_${type}`. */
    appliedTaxes: any;
}
                ...
                <div className="w-full text-sm">
                    <table className="w-full min-w-max table-auto text-left">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200 text-xs">
                            {printInvoice?.Products?.map((item: any, index: number) => (
                                <tr key={index}>
                ...
                <div className="flex p-2 text-xs">
                    ...
                    <div className="basis-[50%] max-w-[50%]">
                        ...
                        <div className="flex flex-col text-xs">
                            {appliedTaxes && Object.values(appliedTaxes).map((tax: any, ind: number) => (
                        ...
                        {printInvoice?.Payments.length > 0 ? (
                            printInvoice.Payments.map((payment: any, index: number) => {
