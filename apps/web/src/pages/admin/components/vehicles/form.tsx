...
import { DialogHeader, DialogFooter, DialogBody, Button, Input } from "@material-tailwind/react";
...
interface VehicleFormProps {
    ...
    setSelectedItem: React.Dispatch<React.SetStateAction<Vehicle | null>>;
    refresh: boolean;
    setRefresh: React.Dispatch<React.SetStateAction<boolean>>;
}

const MyPopUpForm = ({ open, close, selectedItem, setSelectedItem, refresh, setRefresh }: VehicleFormProps) => {
    const { state } = State();
    ...
    const clearForm = (formikProps: ReturnType<typeof useFormik<VehicleFormValues>>) => {
