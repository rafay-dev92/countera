...
import type { Product as ProductEntity } from "@/types/api";
...
export function Product() {
    ...
    const [finalItems, setFinalItems] = useState<ProductEntity[]>([]);
    ...
    const [selectedItem, setSelectedItem] = useState<ProductEntity | null>(null);
                            ...
                            {currentItems.map(({ id, name, price, cost, itemCode, type, taxable }, index) => {
                                ...
                                return (
                                    <tr key={id}>
                                        ...
                                        <td className={classes}>
                                            <Checkbox color="green" checked={(taxable ? 'checked' : '') as any} readOnly crossOrigin={undefined} />
                                        </td>
                                        <td className={classes}>
