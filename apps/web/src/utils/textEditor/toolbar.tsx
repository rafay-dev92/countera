...
/** `this` is bound by Quill's toolbar module to the toolbar instance. */
interface ToolbarHandlerContext {
    quill: any;
}

// Undo and redo functions for Custom Toolbar
function undoChange(this: ToolbarHandlerContext) {
    this.quill.history.undo();
}
function redoChange(this: ToolbarHandlerContext) {
...
function handleLineHeightChange(this: ToolbarHandlerContext, value: string) {
