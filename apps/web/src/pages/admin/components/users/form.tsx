...
import type { ApiUser, Business, Permission as ApiPermission } from "@/types/api";
...
const MyPopUpForm = ({ open, close, selectedItem, setSelectedItem, refresh, setRefresh }: UserFormProps) => {
    const { state } = State();
    ...
    const getPermissions = async () => {
        try {
            ...
            const permissions = (await res.json()) as ApiPermission[];
