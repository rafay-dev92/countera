             ...
             <div ref={ref} className={`w-[794px] min-h-[1123px] bg-white mx-auto flex flex-col ${!view ? "hidden print:flex" : ""}`}>
                <div className="grid grid-cols-2 border-b">
                    ...
                    <div className="col-span-1 flex flex-col items-end gap-1 p-2">
                        ...
                        <span className="text-[12px]">License No: {workOrderData?.Business.licenseNumber}</span>
                        <span className="text-[12px]">Permit No: {workOrderData?.Business.permitNumber}</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-3 divide-x">
                    ...
                    <div className="col-span-1 flex flex-col gap-1 p-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs">{workOrderData?.Customer?.Address && workOrderData?.Customer.Address.street}</span>
                            <span className="text-xs">{workOrderData?.Customer?.Address && `${workOrderData?.Customer?.Address?.city}, ${workOrderData?.Customer?.Address?.state}, ${workOrderData?.Customer?.Address?.zipcode}`}</span>
                            <span className="text-xs">{workOrderData?.Customer?.phone && `Phone: ${workOrderData?.Customer.phone}`}</span>
                        </div>
                    </div>
