...
const ViewQuotation = ({ quotationData, setQuotationData, componentRef, appliedTaxes, setEdit, close }: ViewQuotationProps) => {
    ...
    const sendMailToUser = async () => {
        ...
        try {
            ...
            formData.append("businessName", state?.business?.name as string);
            formData.append("businessEmail", state?.business?.email as string);
