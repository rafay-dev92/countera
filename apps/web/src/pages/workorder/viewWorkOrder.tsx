...
import { WorkOrderStatus } from "@countera/shared";
...
const ViewWorkOrder = ({ workOrderData, setWorkOrderData, componentRef, appliedTaxes, setEdit, close }: ViewWorkOrderProps) => {
