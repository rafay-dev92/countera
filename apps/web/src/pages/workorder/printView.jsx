            ...
            <div ref={ref} className={`${!view ? "hidden print:block" : ""}`}>
                <div className="flex items-center justify-between p-4">
                    <div className="flex flex-col gap-1">
                        <h3 className="text-2xl font-bold mb-3">{workOrderData?.Business.name}</h3>
                        <div className="flex items-center gap-4">
                            <div className="flex flex-col items-start justify-start">
                                <span className="text-sm font-normal text-black">{workOrderData?.Business.address}</span>
                                <span className="text-sm font-normal text-black">{workOrderData?.Business.city}, {workOrderData?.Business.state}, {workOrderData?.Business.zipcode}</span>
                                <span className="text-sm font-normal text-black">Phone: {workOrderData?.Business.tel}</span>
                                <span className="text-sm font-normal text-black">Fax: {workOrderData?.Business.fax}</span>
                                <span className="text-sm font-normal text-black">Email: {workOrderData?.Business.email}</span>
                            </div>
                            <img src={workOrderData?.Business.logo} className="rounded-xl h-[100px] w-[100px]" alt="Business logo" width={100} height={100} />
                        </div>
                    </div>
                    {workOrderData?.approved && (
                        <div className="">
                ...
                <div className="flex justify-between items-center p-4">
                            ...
                            <tbody>
                                <tr>
                                    <td className="p-2 border-b border-blue-gray-50 space-y-2">
                                        ...
                                        >
                                            {workOrderData.Customer.firstName} {workOrderData.Customer.lastName}
                                        </Typography>
                                        <Typography
                                            variant="small"
                                            color="blue-gray"
                    ...
                    <div className="flex border border-black-2">
                        ...
                        <div className="flex flex-col divide-y">
                            <span className="text-xs p-2">{workOrderData?.CustomerVehicle.licenseNo? workOrderData?.CustomerVehicle.licenseNo : 'N/A'}</span>
                            <span className="text-xs p-2">{workOrderData?.CustomerVehicle.odometer}</span>
                            <span className="text-xs p-2">{workOrderData?.CustomerVehicle.year}</span>
                            <span className="text-xs p-2">{workOrderData?.CustomerVehicle.make}</span>
                            <span className="text-xs p-2">{workOrderData?.CustomerVehicle.model}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex p-2">
                    ...
                    <div className="basis-[50%] max-w-[50%]">
                        <div className="flex items-center justify-center border divide-x">
                            ...
                            <h1 className="basis-[50%] max-w-[50%] text-1xl p-2">${calculateTotalAmount(workOrderData.Product)}</h1>
                        </div>
                        ...
                        <div className="flex items-center border divide-x">
                            ...
                            <h1 className="basis-[50%] max-w-[50%] text-1xl p-2">${workOrderData?.totalAmount}</h1>
                        </div>
                    </div>
                </div>
            </div>
