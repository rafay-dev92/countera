...
interface CategoryFormProps {
    ...
    setSelectedItem: React.Dispatch<React.SetStateAction<ProductCategory | null>>;
    refresh: boolean;
    setRefresh: React.Dispatch<React.SetStateAction<boolean>>;
}

const Form = ({ open, close, selectedItem, setSelectedItem, refresh, setRefresh }: CategoryFormProps) => {
    ...
    useEffect(() => {
        if (selectedItem) {
            formikProps.setValues(selectedItem as unknown as CategoryFormValues);
            setEdit(true);
        }
    }, [selectedItem]);
    ...
    const clearForm = (formikProps: ReturnType<typeof useFormik<CategoryFormValues>>) => {
    ...
    return (
        <>
            <Dialog open={open} size="xs" handler={undefined as any}>
                {open && (
